...
pub fn handle(global: &GlobalArgs, cmd: XrefCmd) -> CliResult<CommandOutcome> {
    match cmd {
        XrefCmd::ListCallers {
            tree,
            mfa,
            ...
            render_display(&OutputContext::from_args(global, "xref list_callers"), &r)
        }
        XrefCmd::ListCallees {
            tree,
            mfa,
            ...
            render_display(&OutputContext::from_args(global, "xref list_callees"), &r)
        }
        XrefCmd::ListUndefined { tree } => {
            let xref = build_xref(&tree)?;
            let r = xref.undefined_function_calls();
            render_display(&OutputContext::from_args(global, "xref list_undefined"), &r)
        }
        XrefCmd::ListUnusedExports { tree } => {
            let xref = build_xref(&tree)?;
            let r = xref.exports_not_used();
            render_display(
                &OutputContext::from_args(global, "xref list_unused_exports"),
                &r,
            )
        }
        XrefCmd::ListUnusedLocals { tree } => {
            ...
            render_display(
                &OutputContext::from_args(global, "xref list_unused_locals"),
                &r,
            )
        }
        XrefCmd::ListDeprecatedCalls { tree } => {
            ...
            render_display(
                &OutputContext::from_args(global, "xref list_deprecated_calls"),
                &r,
            )
        }
        XrefCmd::ListUnresolved { tree } => {
            ...
            render_display(
                &OutputContext::from_args(global, "xref list_unresolved"),
                &r,
            )
        }
        XrefCmd::ListModuleDeps {
            ...
            if forward {
                ...
                render_display(
                    &OutputContext::from_args(global, "xref list_module_deps"),
                    &r,
                )
            } else {
        ...
        XrefCmd::ListBehaviourUsers { tree, behaviour } => {
            ...
            render(
                &OutputContext::from_args(global, "xref list_behaviour_users"),
                &r,
                |w| {
                    for m in &r {
                        writeln!(w, "{m}")?;
        ...
        XrefCmd::ListModuleCycles { tree } => {
            ...
            render(
                &OutputContext::from_args(global, "xref list_module_cycles"),
                &cycles,
                |w| {
                    for cycle in &cycles {
